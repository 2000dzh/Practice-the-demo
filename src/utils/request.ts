...
declare module 'axios' {
  export interface AxiosResponse<T = any> extends Promise<IResponseData> { }
}
...
class AxiosHttpRequest implements BaseType {
  ...
  timeout: number;
  constructor() {
    this.baseURL = 'http://pcapi-xiaotuxian-front-devtest.itheima.net/'
    this.timeout = 4000
  }
  // 配置参数
  getConfigParams() {
  ...
  request(options: AxiosRequestConfig) {
    ...
    // return instance.request<IResponseData>(options).then(res => res.data.result)
